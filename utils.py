...
parser.add_argument('--encoder', choices=['affine', 'conv-1', 'conv-2', 'resnet'], default='conv')
parser.add_argument('--synthesis', choices=['affine', 'conv-1', 'conv-2', 'resnet', 'style'], default='style')
parser.add_argument('--encoder-norms', choices=['sn', 'bn'], nargs='*', default=[])
parser.add_argument('--synthesis-norms', choices=['sn', 'bn'], nargs='*', default=[])
